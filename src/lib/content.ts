...
const Content = {
    ...
    variants: {
        queertrans: {
        intro: "The 22nd Law Commission has called for suggestions on the Uniform Civil Code. Use this link to send a letter to the Chairperson of the Law Commission demanding that queer and trans perspectives are not ignored in any deliberations on changes to family law.",
